...
from components.pages.basic_stats.set_basic_stats_by_season_by_comp import set_basic_stats_by_season_by_comp
...
class BasicStats(BasePage):
    def content(self):
        ...
        seasons_ids = choose_season_button(db_conn, name_comp)

        st.divider()

        if seasons_ids:
            set_basic_stats_by_season_by_comp(db_conn, name_comp, seasons_ids)
